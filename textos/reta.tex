Nesta seção, será tomado como exemplo a relação de corrente e tensão em um resistor, dado na teoria por (\ref{eq:resist}). São os mesmos dados da figura \ref{fig:basico:importado}, da seção \nameref{sec:basico:renome}, que foram gerados por computador.
